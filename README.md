...
```javascript
import daysInYear from 'https://cdn.jsdelivr.net/gh/stdlib-js/time-days-in-year@v0.2.3-esm/index.mjs';
```
...
[test-image]: https://github.com/stdlib-js/time-days-in-year/actions/workflows/test.yml/badge.svg?branch=v0.2.3
[test-url]: https://github.com/stdlib-js/time-days-in-year/actions/workflows/test.yml?query=branch:v0.2.3
